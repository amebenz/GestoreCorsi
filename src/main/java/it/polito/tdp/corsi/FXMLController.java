...
public class FXMLController {
    ...
    void corsiPerPeriodo(ActionEvent event) {
    	...
    	try {
    		...
    		txtRisultato.setText("Inserisci numero 1 o 2!");
    		return;
    	}
    ...
    @FXML
    void numeroStudenti(ActionEvent event) {  txtRisultato.clear();
    ...
    void stampaDivisione(ActionEvent event) {
    	...
    	if(!this.model.esisteCorso(codins)) {
    		txtRisultato.appendText("Il corso di studi non esiste!\n");
    		return;
    	}
